...
def isBetween(board,color,betweencol1,betweencol2,isTrue=True):
    ...
    for i in cPos:
        if (board[i[0]+1][i[1]]==betweencol1 and board[i[0]-1][i[1]]==betweencol2) or (board[i[0]+1][i[1]]==betweencol2 and board[i[0]-1][i[1]]==betweencol1) or (board[i[0]][i[1]+1]==betweencol1 and board[i[0]][i[1]-1]==betweencol2) or (board[i[0]][i[1]+1]==betweencol2 and board[i[0]][i[1]-1]==betweencol1)
            return True
    return not(isTrue)^False
